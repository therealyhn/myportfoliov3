...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 lg:py-28 border-t border-line">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="flex-1 flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <span className="w-9 h-9 border border-line flex items-center justify-center text-muted group-hover:border-accent/40 group-hover:text-accent transition-colors duration-200">
              ...
              <div className="flex items-center gap-2 pt-1">
                {SOCIALS.map(({ label, href, icon }) => (
                  <a
                    ...
                    aria-label={label}
                    className="w-9 h-9 border border-line flex items-center justify-center text-muted hover:border-accent/40 hover:text-accent transition-colors duration-200"
                  >
